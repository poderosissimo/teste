  ...
  async createOrder(@common.Body() data: OrderCreateInput): Promise<Order> {
    return await this.service.createOrder({
      ...
      select: {
        ...
        createdAt: true,
        id: true,
        orderAppointmentDate: true,
        orderClientId: true,
        orderComissionValue: true,
        orderCreatedAt: true,
        orderExtraCost: true,
        orderHaveFidelity: true,
        orderNormalCost: true,
        orderOwnerId: true,
        orderPaidByClientField: true,
        orderPaymentForm: true,
        orderPercentageAdopted: true,
        orderPointsUsed: true,
        orderProfessionalId: true,
        orderRequestId: true,
