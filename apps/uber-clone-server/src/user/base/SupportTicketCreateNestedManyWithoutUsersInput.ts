...
@InputType()
class SupportTicketCreateNestedManyWithoutUsersInput {
...
export { SupportTicketCreateNestedManyWithoutUsersInput as SupportTicketCreateNestedManyWithoutUsersInput };
