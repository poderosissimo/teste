...
const service = {
  ...
  serviceBookings: () => FIND_MANY_RESULT,
  serviceBooking: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("ServiceBooking", () => {
  ...
  test("POST /serviceBookings", async () => {
    await request(app.getHttpServer())
      .post("/serviceBookings")
      .send(CREATE_INPUT)
  ...
  test("GET /serviceBookings", async () => {
    await request(app.getHttpServer())
      .get("/serviceBookings")
  ...
  test("GET /serviceBookings/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/serviceBookings"}/${nonExistingId}`)
  ...
  test("GET /serviceBookings/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/serviceBookings"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /serviceBookings existing resource", async () => {
