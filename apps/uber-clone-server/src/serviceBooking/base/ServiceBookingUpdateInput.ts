...
@InputType()
class ServiceBookingUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => ReviewUpdateManyWithoutServiceBookingsInput,
  })
  @ValidateNested()
  @Type(() => ReviewUpdateManyWithoutServiceBookingsInput)
  @IsOptional()
  @Field(() => ReviewUpdateManyWithoutServiceBookingsInput, {
    nullable: true,
  })
...
export { ServiceBookingUpdateInput as ServiceBookingUpdateInput };
