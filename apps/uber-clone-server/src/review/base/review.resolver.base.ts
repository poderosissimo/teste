...
export class ReviewResolverBase {
  ...
  async createReview(@graphql.Args() args: CreateReviewArgs): Promise<Review> {
    return await this.service.createReview({
      ...
      data: {
        ...
        serviceBooking: args.data.serviceBooking
          ? {
              connect: args.data.serviceBooking,
            }
          : undefined,
  ...
  @graphql.ResolveField(() => ServiceBooking, {
    nullable: true,
    name: "serviceBooking",
  })
  async getServiceBooking(
    @graphql.Parent() parent: Review
  ): Promise<ServiceBooking | null> {
    const result = await this.service.getServiceBooking(parent.id);
