...
@InputType()
class ServiceBookingUpdateManyWithoutProvidersInput {
...
export { ServiceBookingUpdateManyWithoutProvidersInput as ServiceBookingUpdateManyWithoutProvidersInput };
