...
@InputType()
class ServiceBookingCreateNestedManyWithoutProvidersInput {
...
export { ServiceBookingCreateNestedManyWithoutProvidersInput as ServiceBookingCreateNestedManyWithoutProvidersInput };
