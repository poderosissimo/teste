...
@InputType()
class SupportTicketCreateNestedManyWithoutProvidersInput {
...
export { SupportTicketCreateNestedManyWithoutProvidersInput as SupportTicketCreateNestedManyWithoutProvidersInput };
