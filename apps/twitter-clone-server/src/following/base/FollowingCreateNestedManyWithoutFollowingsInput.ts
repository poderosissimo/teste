...
@InputType()
class FollowingCreateNestedManyWithoutFollowingsInput {
...
export { FollowingCreateNestedManyWithoutFollowingsInput as FollowingCreateNestedManyWithoutFollowingsInput };
