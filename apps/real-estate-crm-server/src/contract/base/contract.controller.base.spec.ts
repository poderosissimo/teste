  ...
  test("POST /contracts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        renewalAlertDate: CREATE_RESULT.renewalAlertDate.toISOString(),
      ...
      .expect([
        {
          ...
          renewalAlertDate: FIND_MANY_RESULT[0].renewalAlertDate.toISOString(),
  ...
  test("GET /contracts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        renewalAlertDate: FIND_ONE_RESULT.renewalAlertDate.toISOString(),
