...
export class PostResolverBase {
  ...
  @graphql.ResolveField(() => Feed, {
    nullable: true,
    name: "feed",
  })
  async getFeed(@graphql.Parent() parent: Post): Promise<Feed | null> {
    const result = await this.service.getFeed(parent.id);
